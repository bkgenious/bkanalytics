...
const Footer = memo(function Footer() {
    ...
    return (
        <footer className="bg-neutral-50 dark:bg-neutral-900/60 border-t border-neutral-200 dark:border-neutral-800">
            <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12 lg:py-16">
                    ...
                    <div>
                        <Link href="/" className="flex items-center space-x-3 mb-4">
                            <div className="flex space-x-0.5">
                                <div className="w-1.5 h-5 bg-primary-600 dark:bg-primary-400 rounded-sm" />
                                <div className="w-1.5 h-3.5 bg-primary-500 dark:bg-primary-400 rounded-sm" />
                                <div className="w-1.5 h-2 bg-primary-400 dark:bg-primary-500 rounded-sm" />
                            </div>
                        ...
                        <p className="text-sm text-neutral-500 dark:text-neutral-400 leading-relaxed max-w-xs">
                            Enterprise-grade analytics and visualization solutions for data-driven organizations.
                        </p>
                    </div>
                ...
                <div className="mt-12 pt-8 border-t border-neutral-200 dark:border-neutral-800">
                    <p className="text-sm text-neutral-400 dark:text-neutral-500 text-center">
                        © {currentYear} DataInsight. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
